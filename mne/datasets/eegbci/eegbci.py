...
#          Ramiro Gatti <rgatti@ingenieria.uner.edu.ar>
# License: BSD Style.
...
def data_path(url, path=None, force_update=False, update_path=None,
    ...
    remote EEGBCI dataset [1]_ which is available at PhysioNet [2]_ or BNCI 
    [3]_.
...
@verbose
def load_eegmmidb(subject, runs, path=None, force_update=False, 
            update_path=None, base_url=EEGMMIDB_URL, 
